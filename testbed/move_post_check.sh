...
echo '***********************************************' | tee -a ${log_file}
if isSelectedApp "php53_app"; then
    php53_app_check ${php53_app} ${rhlogin} ${password} "1" "2" "scale-down" || failed_app="${failed_app}${php53_app} "
fi


echo '***********************************************' | tee -a ${log_file}
if isSelectedApp "perl510_app"; then
...
echo '***********************************************' | tee -a ${log_file}
if isSelectedApp "scalable_php53_app"; then
